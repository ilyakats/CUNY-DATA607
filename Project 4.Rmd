...
```{r}
film_plots <- read.csv(file = "C:\\Users\\ikats\\Documents\\film_plots.csv")
```
...
```{r}
film_plots <- read.csv(file = "C:\\Users\\ikats\\Documents\\film_plots2.csv")
...
```{r}
film_plots <- read.csv(file = "C:\\Users\\ikats\\Documents\\film_plots3.csv")
...
Maximum Entropy model identified the most comedies and it predicted the classification with about 65% accuracy. I wanted to get general analytics as calculated by the `RTextTools` package. Unfortunately, the `create_analytics` method only understands numeric values. 
